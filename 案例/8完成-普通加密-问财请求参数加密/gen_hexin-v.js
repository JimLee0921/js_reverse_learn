...
var En = a[8]
var An = v(a[35], s[49])
var TOKEN_SERVER_TIME = 1744937221.154;
...
const tt = {
    ...
    getPlatform: function V() {
        return 1;
    },
    getBrowserIndex: function M() {
        return 10;
    },
...
!function (n) {
    var t = e[87], o = a[8], i = e[8], f = s[215], l = r[52], p = s[0], d = parseInt(c[216], u[122]), h = e[86],
        g = u[217],
        w = u[123], m = e[165], I = parseInt(t + En, c[122]), y = parseInt(a[79], a[82]), _ = c[218],
        C = parseInt(a[193], e[82]), E = parseInt(o + i, r[78]), A = parseInt(u[219], s[122]),
        b = parseInt(f + An, s[106]),
        T = parseInt(r[194], s[106]), B = parseInt(ot(s[220], e[195]), r[82]), R = parseInt(e[196], u[122]),
        k = parseInt(e[197], a[78]), S;
...
// 在 js 中的测试代码可能会影响使用 pyexecjs 时的执行结果
