...
var Ob7U = function (cio4s, cie4i) {
    var m6g = [];
    bh6b(cio4s, function (chY4c) {
        m6g.push((cie4i || mT9K.emj)[chY4c])
    });
    return m6g.join("")
};
bh6b = function (k6e, cG7z, O6I) {
    if (!k6e || !k6e.length || !gS8K(cG7z))
        return this;
    if (!!k6e.forEach) {
...
gS8K = function (i6c) {
    return Hw6q(i6c, "function")
};
var Hw6q = function (i6c, u6o) {
    try {
        u6o = u6o.toLowerCase();
        if (i6c === null)
            return u6o == "null";
        ...
        return {}.toString.call(i6c).toLowerCase() == "[object " + u6o + "]"
    } catch (e) {
        return !1
    }
};
...
console.log(Ob7U(["流泪", "强"], mT9K.emj)); // 010001
console.log(Ob7U(mT9K.md, mT9K.emj)) // 
console.log(Ob7U(["爱心", "女孩", "惊恐", "大笑"], mT9K.emj)) // 0CoJUm6Qyw8W8jud
...
function encrypt(params) {
    return d(JSON.stringify(params),
        "010001",
        "",
        "0CoJUm6Qyw8W8jud"
    )
